 ...
 */
public class BoardingLocationTask extends AsyncTask<String,Void,String> {
    Context ctx;
    BoardingLocationAdapter adapter;
    ProgressBar progressBar;
    public BoardingLocationTask(Context context,BoardingLocationAdapter boardingLocationAdapter,ProgressBar bar){
        this.ctx=context;
        this.adapter=boardingLocationAdapter;
    ...
    protected String doInBackground(String... params) {
        String link="https://mewmew.000webhostapp.com/bluebus/app_files/boardingDroppingData.php";
    ...
    protected void onPostExecute(String s) {
        if(s==null){
            ...
            try {
                ...
                JSONArray jsonArray=jsonObject.optJSONArray("boarding_data");
                String id,station;
                int count=0;
                while(count<jsonArray.length()){
                    ...
                    BoardingLocationRows row=new BoardingLocationRows(id,station);
                    adapter.add(row);
